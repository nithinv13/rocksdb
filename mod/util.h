...
namespace adgMod {
    ...
    extern rocksdb::DBImpl* db;
    extern rocksdb::ReadOptions read_options;
    extern rocksdb::WriteOptions write_options;
    ...
    extern rocksdb::port::Mutex compaction_counter_mutex;
    extern rocksdb::port::Mutex learn_counter_mutex;
    extern rocksdb::port::Mutex file_stats_mutex;
    // data for CBA
